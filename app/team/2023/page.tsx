...
const page = () => {
  return (
    ...
    <div className="w-full min-h-screen flex flex-col items-center  px-10 md:px-16 lg:px-24 pt-32 pb-10">
        ...
        <div className="w-full flex justify-center flex-wrap gap-12 max-sm:gap-8 mt-8 z-20">
