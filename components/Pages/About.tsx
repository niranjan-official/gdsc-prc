...
const About = () => {
    ...
    return (
        <section
            id="about"
            className="min-h-screen flex flex-col items-center justify-center py-10 md:py-24 select-none"
        >
                    ...
                    <div className="mb-8 md:mb-20 text-center">
                        ...
                        <FadeUp>
                            <p className="text-lg md:text-xl text-neutral-300 max-w-4xl mx-auto leading-relaxed">
                                ...
                                are a passionate group of people who work
                                towards bringing a change in the ecosystem of{" "}
                                <PointerHighlight
                                    rectangleClassName="bg-green-500/10 border-neutral-300 dark:border-neutral-600 leading-loose"
                                ...
                                around the campus. We want to create a healthy
                                environment for the budding developers to
                                explore{" "}
                                ...
                                <PointerHighlight
                                    rectangleClassName="bg-orange-500/10 border-neutral-300 dark:border-neutral-600 leading-loose"
